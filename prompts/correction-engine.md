...
Preserve personalization variables such as {{FirstName}}, {{CompanyName}}, and {{Designation}}.
Return:
1. Corrected copy
2. Key improvements
3. Remaining risks
...
Avoid exaggerated claims, vague buzzwords, overly casual phrasing, and generic sales copy.
Improve the CTA if it is weak, vague, or not action-oriented.

Score the email from 0-100 for:
- Brand voice
- Clarity
- CTA strength
...
2. Problems found
3. Suggested rewrite
4. Stronger subject line options
5. Stronger CTA options
```
